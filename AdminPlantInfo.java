...
public class AdminPlantInfo extends JFrame implements ActionListener,MouseListener
{
	
	JPanel panel;
	JButton search,  back, logout,search2;
		...
		else if(text.equals(search2.getText()))
		{
			...
			try
			{
				...
				while(rs.next())
				{
					...
					this.setVisible(false);
					AdminPlant m = new AdminPlant(this,tree);
					m.setVisible(true);
					tsearch.setText("");
					tsearch2.setText("");
				}
